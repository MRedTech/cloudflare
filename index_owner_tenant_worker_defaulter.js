 ...
 * - A DEFAULTER-mode record is identified by reason = DEFAULTER plus an
 *   intentionally blank id_norm. NORMAL registration always requires ID,
 *   so old NORMAL records that merely used reason DEFAULTER stay separate.
 * ========================= */
...
async function handleSubmit(data, env, ctx, cors) {
  ...
  const isDefaulterWalkIn =
    value.mode === "DEFAULTER" && cleanUpper(value.regnum, 30) === "WALK-IN";
