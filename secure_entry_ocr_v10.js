      ...
      system_instruction: {
        parts: [{
          text:
            ...
            "4. PARTIAL is only for a mostly visible field with a very small local defect, roughly 1-2 imperfect characters that are STILL visually distinguishable enough for one direct reading. " +
            "5. If an imperfect character cannot actually be distinguished and would require guessing, use OCCLUDED or UNREADABLE instead of PARTIAL. " +
            "6. The question is visual evidence, not whether you think you can guess the answer."
        }]
      },
      contents: [{
        parts: [
      ...
      system_instruction: {
        parts: [{
          text:
            ...
            "Tolerance: about 1-2 slightly imperfect characters may still be acceptable ONLY if they remain visually distinguishable enough that there is one direct reading. " +
            "If they are not actually distinguishable, use ? and confidence=UNCERTAIN. " +

            "HARD RULES: " +
            "1. Never autocomplete names or MyKad/passport/licence numbers. " +
            "2. Never infer hidden digits from MyKad date/state structure or expected format. " +
            "3. Never infer spelling from common Malay names or surrounding address/context. " +
            "4. If usedInference=true, confidence MUST be UNCERTAIN and name/idnum MUST be empty. " +
            "5. If any ? appears in visibleName or visibleId, confidence MUST be UNCERTAIN and name/idnum MUST be empty. " +
            "6. If confidence=CONFIDENT, visibleName must equal name and visibleId must equal idnum after only space/dash normalization. " +
            "7. Accuracy is more important than autofill."
        }]
      },
      contents: [{
        parts: [
