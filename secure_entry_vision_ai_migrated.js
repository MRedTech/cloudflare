export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // Primary model uses ENV. Fallback handles temporary capacity/rate-limit
      // errors and model-specific availability errors.
      const PRIMARY_MODEL = (env.GEMINI_MODEL || "gemini-3.5-flash-lite").trim();
